      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            {pagination.total} товаров в выборке (Стр. {pagination.page} из {Math.max(1, pagination.totalPages)})
          </p>
        </div>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-slate-700 mb-6">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="relative flex-1 min-w-[200px]">
            ...
            <input
              type="text"
              placeholder="Поиск товаров (Enter для поиска)..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-900 dark:text-white"
            />
          </div>
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-gray-50 dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-xl hover:bg-gray-100 min-w-[200px]"
            >
            ...
            <div className="flex items-center justify-between border-t border-gray-200 pt-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-3 py-2 rounded-lg border border-gray-200 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1 text-sm font-medium"
                >
