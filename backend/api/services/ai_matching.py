...
5. ⚠️ МУЛЬТИПАКИ: Товар с "2x", "2 x", "6x", "4шт", "упаковка 6" и т.п. - это МУЛЬТИПАК (несколько штук). 
   Мультипак НЕЛЬЗЯ сопоставлять с одиночным товаром! "2 x Sprite 0.5L" ≠ "Sprite 0.5L".
   Мультипак можно сопоставить ТОЛЬКО с другим мультипаком такого же количества.
   Если подходящего мультипака нет → "no_match".
6. ⚠️ КОМБО/НАБОРЫ: Товар "Еда + Напиток" (с плюсом "+", "plus", "combo") НЕЛЬЗЯ сопоставлять с просто напитком.
   "Боул + Sprite" ≠ "Sprite". Это разные товары.
